...
<a href="https://www.codecogs.com/eqnedit.php?latex=\inline&space;\bg_black&space;N_h=&space;\frac{N_s}{(\alpha&space;*&space;(N_i&space;&plus;&space;N_o))}" target="_blank"><img src="https://latex.codecogs.com/gif.latex?\inline&space;\bg_black&space;N_h=&space;\frac{N_s}{(\alpha&space;*&space;(N_i&space;&plus;&space;N_o))}" title="N_h= \frac{N_s}{(\alpha * (N_i + N_o))}" /></a>
